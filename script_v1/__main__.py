...
#para obtener las nuevas capas creadas y eliminar archivos anteriores. Tras esto obtenemos una imagen NDVI recortada al area de estudio mediante un poligono
...
#creadas en orden. Y en la consola de resultdos de PyQGIS se imprimen los mensajes de ejecución y resultados del proceso.
...
def main():
    ...
    if NDVImod2execute(parent_path): #comprueba que NDVImod2 se ejecuto correctamente antes de continuar
        if crearpoligonoexecute(parent_path): #comprueba que crearpoligono se ejecuto correctamente antes de continuar
            if clipsinfuncionexecute(parent_path): #comprueba que clipsinfuncion se ejecuto correctamente antes de continuar
                if simbolizarRasterbienexecute(parent_path): #comprueba que simbolizarRasterbien se ejecuto correctamente antes de continuar
...
def NDVImod2execute(parent_path):
    ...
    print ('NDVImod2 executed succesfully!')
...
def clipsinfuncionexecute(parent_path):
    print ('clipsinfuncion started!')
    ...
    print ('clipsinfuncion executed succesfully!')
...
def simbolizarRasterbienexecute(parent_path):
    print ('simbolizarRasterbien started!')
    ...
    print ('simbolizarRasterbien executed succesfully!')
